...
# ==============================================================================
# Modified by -np for newer tf version, deprecated functions etc.
# ==============================================================================
...
def maybe_download_and_extract(data_url):
  ...
  if not os.path.exists(filepath):
    ...
    tf.logging.info('Successfully downloaded {}, {} bytes'.format(filename,
                                                                  statinfo.st_size))
...
def invoke(flags_, unparsed_):
  global FLAGS
  FLAGS, unparsed = flags_, unparsed_
  main([sys.argv[0]])


def main(_):#,image_dir):
